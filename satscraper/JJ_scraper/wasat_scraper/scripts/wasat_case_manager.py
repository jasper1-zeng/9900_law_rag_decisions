#!/usr/bin/env python3
"""
wasat_case_manager.py - WASAT Case Management System
...
3. Command-line support:
   - python wasat_case_manager.py: Run full scraping
   - python wasat_case_manager.py rss: Run only RSS update
...
def main():
    """
    Main function to run the case manager
